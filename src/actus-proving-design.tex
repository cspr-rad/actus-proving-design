...
\caption{Recursive (i.e., branch) proving cases for instances of $h_0 \equiv h_1$, meaning that $h_0$ and $h_1$ are both root hashes of Merkelizations of the same value.}
