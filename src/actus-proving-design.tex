...
TODO: can we be more intelligent about considering which events matter for which contracts or is that a lost cause? Currently best case proving complexity is $O(nm)$ in $n$ the number of contracts and $m$ the number of events
